 ...
 * app — [com.tucavr.navigation.PlaybackSource] (ja existente, ver
 ...
 * [com.tucavr.navigation.PlaybackSource] sempre atraves de UMA unica
 ...
 */
enum class HistorySourceType { LOCAL, SMB, HTTP, FTP, SFTP, NFS, DLNA, WEBDAV }
...
data class PlaybackHistory(
     ...
     * [com.tucavr.network.SmbServer] salvo por `serverId`).
     */
